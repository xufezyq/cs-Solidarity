...
![sequence-agent](images/sequence-agent.png)
...
![main-loop](images/main-loop.png)
...
> 消息路由的两级模式：独占前缀路由 + 广播路由，确保消息不重复处理。
...
![steam-flow](images/steam-flow.png)
...
![monkey-patch](images/monkey-patch.png)
